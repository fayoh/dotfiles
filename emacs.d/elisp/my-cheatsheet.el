...
(cheatsheet-add-group 'Common
                      ...
                      '(:key "C-x v g" :description "diff-hl-diff-goto-hunk")
                      '(:key "C-x v r" :description  "diff-hl-revert-hunk")
                      ...
                      '(:key "s-<tab>" :description "Yasnippet expansion"))
...
(cheatsheet-add-group 'Magit
                      '(:key "C-x g" :description "Show git status buffer."))
